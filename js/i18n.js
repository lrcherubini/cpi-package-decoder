const translations = {
  "pt-BR": {
    ...
    drag_drop: "📁 Arraste os arquivos .zip aqui ou clique para selecionar",
    ...
    params_in_use: "Parâmetros em Uso",
    orphan_params: "Parâmetros Órfãos",
    global_params: "Parâmetros Globais",
    schedule_type: "Tipo de Agendamento",
    run_once_schedule: "Execução Única",
    recurring_schedule: "Recorrente",
    cron_schedule: "Expressão Cron",
    schedule_datetime: "Data/Hora de Execução",
    repeats_every: "Repetir a cada",
    minutes: "minuto(s)",
    hours: "hora(s)",
    days: "dia(s)",
    start_time: "Início",
  ...
  "en-US": {
    ...
    drag_drop: "📁 Drag ZIP files here or click to select",
    ...
    params_in_use: "Parameters in Use",
    orphan_params: "Orphan Parameters",
    global_params: "Global Parameters",
    schedule_type: "Schedule Type",
    run_once_schedule: "Run Once",
    recurring_schedule: "Recurring",
    cron_schedule: "Cron Expression",
    schedule_datetime: "Scheduled Datetime",
  ...
  "es-ES": {
    ...
    drag_drop: "📁 Arrastra los archivos .zip aquí o haz clic para seleccionarlos",
    ...
    params_in_use: "Parámetros en Uso",
    orphan_params: "Parámetros Huérfanos",
    global_params: "Parámetros Globales",
    schedule_type: "Tipo de Programación",
    run_once_schedule: "Ejecución Única",
    recurring_schedule: "Recurrente",
    cron_schedule: "Expresión Cron",
    schedule_datetime: "Fecha/Hora Programada",
    repeats_every: "Repetir cada",
    minutes: "minuto(s)",
    hours: "hora(s)",
    days: "día(s)",
    start_time: "Inicio",
